...
const Details = (props) => {
    ...
    const fetch_administrator_detail = () => {
        call_secure_api('v1/district-head/administrator/detail', { administrator_id: administrator_id })
            .then(
                async (resolve) => {
    ...
    const logout_all_device = () => {
        call_secure_api('v1/district-head/administrator/logout', { administrator_id: administrator_id })
            .then(
                async (resolve) => {
                    if (resolve.status == true) {
